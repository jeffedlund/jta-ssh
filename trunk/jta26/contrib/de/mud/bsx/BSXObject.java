...
public class BSXObject
{
    ...
    { new Color(0, 0, 0), new Color(0, 0, 255), new Color(34, 139, 34),
	    new Color(135, 206, 235), new Color(205, 92, 92),
	    new Color(255, 105, 180), new Color(165, 42, 42),
	    new Color(211, 211, 211), new Color(105, 105, 105),
	    new Color(0, 191, 255), new Color(0, 255, 0),
	    new Color(0, 255, 255), new Color(255, 99, 71),
     ...
     * @param data
     *            field containing gfx information
     *            <ul>
	...
	for (int polys = 0; polys < data.length; polys++)
	{
	    ...
	    g.fillPolygon(poly[2 * polys], poly[2 * polys + 1],
		    poly[2 * polys].length);
	}
    }
    ...
    {
	return (obj instanceof BSXObject)
		&& ((BSXObject) obj).id.equals(this.id);
    }
