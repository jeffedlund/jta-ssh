...
public final class Blowfish extends Cipher
{
    ...
    /*
     * Blowfish's P and S -boxes, respectively. These were taken from Bruce
     * Schneier's public-domain implementation.
     */
    ...
    { 0xd1310ba6, 0x98dfb5ac, 0x2ffd72db, 0xd01adfb7, 0xb8e1afed, 0x6a267e96,
	    ...
	    0x66a02f45, 0xbfbc09ec, 0x03bd9785, 0x7fac6dd0, 0x31cb8504,
	    0x96eb27b3, 0x55fd3941, 0xda2547e6, 0xabca0a9a, 0x28507825,
	    0x530429f4, 0x0a2c86da, 0xe9b66dfb, 0x68dc1462, 0xd7486900,
	    ...
	    0x3f3125f9, 0x5ef47e1c, 0x9029317c, 0xfdf8e802, 0x04272f70,
	    0x80bb155c, 0x05282ce3, 0x95c11548, 0xe4c66d22, 0x48c1133f,
	    0xc70f86dc, 0x07f9c9ee, 0x41041f0f, 0x404779a4, 0x5d886e17,
	    0x325f51eb, 0xd59bc0d1, 0xf2bcc18f, 0x41113564, 0x257b7834,
	    0x602a9c60, 0xdff8e8a3, 0x1f636c1b, 0x0e12b4c2, 0x02e1329e,
	    ...
	    0x877d48fa, 0xc39dfd27, 0xf33e8d1e, 0x0a476341, 0x992eff74,
	    ...
	    0x11caedfa, 0x3d25bdd8, 0xe2e1c3c9, 0x44421659, 0x0a121386,
	    ...
	    0xc4324633, 0xe85a1f02, 0x09f0be8c, 0x4a99a025, 0x1d6efe10,
	    0x1ab93d1d, 0x0ba5a4df, 0xa186f20f, 0x2868f169, 0xdcb7da83,
	    0x573906fe, 0xa1e2ce9b, 0x4fcd7f52, 0x50115e01, 0xa70683fa,
	    0xa002b5c4, 0x0de6d027, 0x9af88c27, 0x773f8641, 0xc3604c06,
	    0x61a806b5, 0xf0177a28, 0xc0f586e0, 0x006058aa, 0x30dc7d62,
	    0x11e69ed7, 0x2338ea63, 0x53c2dd94, 0xc2c21634, 0xbbcbee56,
	    0x90bcb6de, 0xebfc7da1, 0xce591d76, 0x6f05e409, 0x4b7c0188,
	    0x39720a3d, 0x7c927c24, 0x86e3725f, 0x724d9db9, 0x1ac15bb4,
	    0xd39eb8fc, 0xed545578, 0x08fca5b5, 0xd83d7cd3, 0x4dad0fc4,
	    0x1e50ef5e, 0xb161e6f8, 0xa28514d9, 0x6c51133c, 0x6fd5c7e7,
	    0x56e14ec4, 0x362abfce, 0xddc6c837, 0xd79a3234, 0x92638212,
	    0x670efa8e, 0x406000e0, 0x3a39ce37, 0xd3faf5cf, 0xabc27737,
	    ...
	    0xef5562e9, 0xc72fefd3, 0xf752f7da, 0x3f046f69, 0x77fa0a59,
	    ...
	    0xbcb4cdd5, 0x72eacea8, 0xfa6484bb, 0x8d6612ae, 0xbf3c6f47,
	    ...
	    0xcd3e7e6f, 0x1618b166, 0xfd2c1d05, 0x848fd2c5, 0xf6fb2299,
	    0xf523f357, 0xa6327623, 0x93a83531, 0x56cccd02, 0xacf08162,
	    0x5a75ebb5, 0x6e163697, 0x88d273cc, 0xde966292, 0x81b949d0,
	    0x4c50901b, 0x71c65614, 0xe6c6c7bd, 0x327a140a, 0x45e1d006,
	    0xc3f27b9a, 0xc9aa53fd, 0x62a80f00, 0xbb25bfe2, 0x35bdd2f6,
	    0x71126905, 0xb2040222, 0xb6cbcf7c, 0xcd769c2b, 0x53113ec0,
	    0x1640e3d3, 0x38abbd60, 0x2547adf0, 0xba38209c, 0xf746ce76,
     ...
     * (byte)0xd3, (byte)0x96, (byte)0xcf, (byte)0x07, (byte)0xfa, (byte)0xa2,
     * (byte)0x64, (byte)0xfe, (byte)0xf3, (byte)0xa2, (byte)0x06, (byte)0x07,
     * (byte)0x1a, (byte)0xb6, (byte)0x13, (byte)0xf6, (byte)0x06, (byte)0x18,
     * (byte)0xf6, (byte)0xcc, (byte)0x32, (byte)0xd9, (byte)0xbb, (byte)0x56,
     * (byte)0x5b, (byte)0xa6, (byte)0xa1, (byte)0x72, (byte)0x28, (byte)0xb3,
     * (byte)0xec, (byte)0x64 };
     * 
     * byte[] txt = { (byte)0x2e, (byte)0xbe, (byte)0xc5, (byte)0xac,
     * (byte)0x02, (byte)0xa1, (byte)0xd5, (byte)0x7f, (byte)0x01, (byte)0x00,
     * (byte)0x00, (byte)0x00, (byte)0x1f, (byte)0x43, (byte)0x6f, (byte)0x72,
     * (byte)0x72, (byte)0x75, (byte)0x70, (byte)0x74, (byte)0x65, (byte)0x64,
     * (byte)0x20, (byte)0x63, (byte)0x68, (byte)0x65, (byte)0x63, (byte)0x6b,
     * (byte)0x20, (byte)0x62, (byte)0x79, (byte)0x74, (byte)0x65, (byte)0x73,
     * (byte)0x20, (byte)0x6f, (byte)0x6e, (byte)0x20, (byte)0x69, (byte)0x6e,
     * (byte)0x70, (byte)0x75, (byte)0x74, (byte)0x2e, (byte)0x91, (byte)0x9a,
     * (byte)0x57, (byte)0xdd }; ENC: b5 44 c6 69 9b e7 d7 3d 45 25 0d 8b b3 5a
     * 28 f5 98 eb 3e ea a3 27 e3 ac 64 de fc b7 f5 49 c6 3f 31 5c ce 99 79 b5
     * 3b a9 cc 44 67 f0 46 a3 7e ed
     * 
     ...
     * printHex(txt));
     * 
     * Blowfish cipher = new Blowfish(); cipher.setKey(key);
     * 
     * enc = cipher.encrypt(txt); System.out.println("enc: " + printHex(enc));
     * 
     * cipher = new Blowfish(); cipher.setKey(key); dec = cipher.decrypt(enc);
     * 
