 ...
 * describes the broadcast method that should broad cast the message to all
 * plugins known and return an answer message immediatly.
 * <P>
 * The functionality is just simuliar to a bus, but depends on the actual
